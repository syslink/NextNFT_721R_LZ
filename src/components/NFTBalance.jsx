...
//import tangaNFT from "../contracts/tangaNFT.json";

const TangaNFTContractAddr = '10000000000000000000000000000';
            ...
            NFTBalances.result.map((nft, index) => {
              ...
              return (
                <Card
                  ...
                  key={index}
                >
                  <Meta title={nft.symbol + '#' + nft.token_id} description={nft.token_address} />
                </Card>
              );
            })}
        </Skeleton>
